...
const CreateNFT = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    formData.append('image', img); // ✅ Use singular name if your backend expects one
    ...
    try {
      ...
      const imageFile = data.url.split("/").pop();
      console.log("imageFile:", imageFile);

      
      setTokenURI(data.url);
    ...
    try {
      ...
      const nft = { tokenURI, price, title, description, walletProvider }
